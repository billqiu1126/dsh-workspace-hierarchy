window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function FlatList({ useSessions, open, forkSession, onSessionRename, onSessionArchive, archivedSessionIds, orderBy, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, onSessionDelete, t }) {
			const list = useSessions((s) => s);
