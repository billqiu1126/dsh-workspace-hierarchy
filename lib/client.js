	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"rename.desc": "将把工作区重命名为新名称，并同步重命名磁盘文件夹（原路径：{cwd}）。该文件夹下的会话与子工作区会一并迁移。完成后请重启 dsh web。",
		...
		const en = {
			...
			"rename.desc": "Renames the workspace and its folder on disk (current path: {cwd}). Sessions and sub-workspaces under it are migrated along. Restart dsh web afterwards.",
